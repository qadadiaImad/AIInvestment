...
export const BUBBLES_FRAMES = 5263;   // 175s
...
const BEATS: Beat[] = [
  {at: 0,
   ...
   line: "Kid... let me show you the machine behind every crash."},
  ...
  {at: 150,
   ...
   vo: "b02_rex_badbanks", speaker: "REX",
   line: "Boss! It's all just bad banks, right?!"},

  {at: 263,
   actors: [{poses: ["sol_smug_v1"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b03_sol_ha", speaker: "SOL",
   line: "HA! ...Bad banks."},

  {at: 325,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b04_sol_math", speaker: "SOL",
   line: "Sometimes... it's just MATH."},
  ...
  {at: 458,
   ...
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b06_sol_fourparts", speaker: "SOL",
  ...
  {at: 571,
   ...
   line: "Give me a name, boss. I'll write it down."},
  ...
  {at: 763,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b09_sol_partone", speaker: "SOL",
  ...
  {at: 921,
   ...
   line: "Cheap. ...Like the loan you couldn't afford - suddenly you can."},
  ...
  {at: 1389,
   ...
   line: "Part two. A story shows up."},
  ...
  {at: 3644,
   actors: [{poses: ["rex_eager"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b35_rex_third", speaker: "REX",
   line: "A THIRD of a house, gone?"},
  ...
  {at: 4089,
   actors: [{poses: ["rex_listen"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b40_rex_witht", speaker: "REX",
   line: "Trillion? With a T?"},

  {at: 4162,
   actors: [{poses: ["sol_smug_v1"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b41_sol_witht", speaker: "SOL",
   line: "With a T, kid."},
