...
export const BUBBLES_FRAMES = 6057;   // 202s
...
const BEATS: Beat[] = [
  {at: 0,
   ...
   vo: "b01_sol_machine", speaker: "SOL",
   line: "Kid... before we do 2008, I want to show you the machine."},
  ...
  {at: 144,
   ...
   vo: "b02_rex_what", speaker: "REX",
   line: "The machine?! I thought we were doing the housing crash - the banks, ALL of it!"},

  {at: 336,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b03_sol_running", speaker: "SOL",
   line: "We are. The housing crash is just this thing running one more time."},

  {at: 495,
   exhibit: "b_empty_chair",
   actors: [{poses: ["rex_skeptic"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b04_rex_name", speaker: "REX",
   line: "So who breaks it? Give me a name - I'll write it down."},

  {at: 649,
   graphic: "machine_parts",
   actors: [{poses: ["sol_smug_v1"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b05_sol_four", speaker: "SOL",
   line: "HA! ...Nobody breaks it alone. Four parts run it. Every time."},

  {at: 795,
   graphic: "fedfunds",
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b06_sol_cheap", speaker: "SOL",
   line: "Part one. Money gets cheap."},

  {at: 876,
   actors: [{poses: ["rex_listen"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b07_rex_onsale", speaker: "REX",
   line: "Cheap like... on sale?"},

  {at: 947,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b08_sol_loan", speaker: "SOL",
   line: "Cheap like the loan that cost you a lot now costs you a little."},

  {at: 1110,
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b09_sol_months", speaker: "SOL",
   line: "It sat under one and a half percent for twenty-two months."},

  {at: 1246,
   exhibit: "b_corkboard",
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b10_sol_story", speaker: "SOL",
   line: "Part two. A story shows up that explains why the price makes sense."},

  {at: 1404,
   actors: [{poses: ["rex_skeptic"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b11_rex_true", speaker: "REX",
   line: "In '08 the story was - houses always go up. That's just true, isn't it?"},

  {at: 1585,
   graphic: "caseshiller",
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b12_sol_only", speaker: "SOL",
   line: "It was true. Right up until it was the only reason anyone gave for the price."},

  {at: 1772,
   exhibit: "b_block_tower",
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b13_sol_leverage", speaker: "SOL",
   line: "Part three. Leverage. Borrowed money, stacked on borrowed money."},

  {at: 1909,
   actors: [{poses: ["rex_eager"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b14_rex_crowbar", speaker: "REX",
   line: "Leverage, like a crowbar? More leverage means more power - that's GOOD, right?"},

  {at: 2106,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b15_sol_wobble", speaker: "SOL",
   line: "More leverage means a small wobble at the bottom becomes a collapse at the top."},

  {at: 2279,
   exhibit: "b_falling_card",
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b16_sol_sell", speaker: "SOL",
   line: "Part four. Someone has to sell."},

  {at: 2364,
   actors: [{poses: ["rex_skeptic"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b17_rex_margin", speaker: "REX",
   line: "Forced? Like margin calls?"},

  {at: 2444,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b18_sol_borrow", speaker: "SOL",
   line: "Borrow to buy. The price drops."},

  {at: 2530,
   graphic: "machine_loop",
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b19_sol_cash", speaker: "SOL",
   line: "The lender wants cash you haven't got - so you sell into a falling market."},

  {at: 2703,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b20_sol_loop", speaker: "SOL",
   line: "That closes the loop. Now watch it run."},

  {at: 2819,
   exhibit: "b_cracked_facade",
   actors: [{poses: ["rex_eager"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b21_rex_banks", speaker: "REX",
   line: "Finally. So - the investment banks. That's the villain. They went first."},

  {at: 2986,
   actors: [{poses: ["sol_smug_v1"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b22_sol_no", speaker: "SOL",
   line: "No."},

  {at: 3041,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b23_sol_tower", speaker: "SOL",
   line: "That's the tower losing its bottom block. Not the hand that built it."},
  ...
  {at: 3197,
   ...
   actors: [{poses: ["rex_skeptic"], kind: "full", x: 298, y: FLOOR_Y, h: 1000},
            {poses: ["sol_finger"], kind: "full", x: 834, y: FLOOR_Y, h: 900}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b24_rex_brokers", speaker: "REX",
   line: "Then it's the brokers who wrote the bad loans! Or the agencies that graded them safe!"},

  {at: 3385,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b25_sol_broker", speaker: "SOL",
   line: "Every hand on this belt touched the loan. The broker who wrote it."},

  {at: 3539,
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b26_sol_bundled", speaker: "SOL",
   line: "The bank that bundled it. The agency that graded it."},

  {at: 3662,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b27_sol_grade", speaker: "SOL",
   line: "The fund that bought the grade - not the house."},

  {at: 3784,
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b28_sol_owner", speaker: "SOL",
   line: "And the homeowner who refinanced, because the story said the price only goes up."},

  {at: 3955,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b29_sol_sitwith", speaker: "SOL",
   line: "That's the part I need you to sit with. Not one desk. Not one signature."},

  {at: 4135,
   actors: [{poses: ["rex_listen"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b30_rex_dodge", speaker: "REX",
   line: "So nobody's responsible? That feels like a dodge."},

  {at: 4258,
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b31_sol_choices", speaker: "SOL",
   line: "Different question. People made choices, and some were bad ones."},

  {at: 4386,
   graphic: "machine_parts",
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b32_sol_fourparts", speaker: "SOL",
   line: "But it didn't need one villain pulling one lever. It needed four ordinary parts pointed the same way at once."},

  {at: 4614,
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b33_sol_notstay", speaker: "SOL",
   line: "And when the fourth part hit, it didn't stay inside mortgages."},

  {at: 4749,
   graphic: "drawdown2008",
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b34_sol_market", speaker: "SOL",
  ...
  {at: 4824,
   ...
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b35_sol_jobs", speaker: "SOL",
   line: "Unemployment went from four point four, to ten percent."},

  {at: 4941,
   graphic: "wealth",
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b36_sol_wealth", speaker: "SOL",
   line: "And eleven and a half trillion dollars of household wealth stopped existing."},

  {at: 5093,
   exhibit: "b_two_machines",
   actors: [{poses: ["rex_skeptic"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b37_rex_once", speaker: "REX",
  ...
  {at: 5207,
   ...
   actors: [{poses: ["sol_point"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b38_sol_backeight", speaker: "SOL",
   line: "Run it back eight years. Same four parts, different story - this time the story was the internet."},

  {at: 5432,
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b39_sol_seventyeight", speaker: "SOL",
   line: "That one fell seventy-eight percent. And it took until twenty-fifteen to get back to even."},

  {at: 5612,
   actors: [{poses: ["rex_shock"], kind: "full", x: 330, y: FLOOR_Y, h: 1000}],
   shots: [{from: 0, k: 1.04, kEnd: 1.12}],
   vo: "b40_rex_fifteen", speaker: "REX",
   line: "Fifteen years?!"},
  ...
  {at: 5677,
   ...
   actors: [{poses: ["sol_finger"], kind: "full", x: 790, y: FLOOR_Y, h: 930}],
   shots: [{from: 0, k: 1.0, kEnd: 1.08}],
   vo: "b41_sol_time", speaker: "SOL",
   line: "A bubble doesn't cost you money, kid. It costs you time. Watch for cheap money, a story, leverage - and someone who has to sell. You'll see it turning long before the headline does."},
];
